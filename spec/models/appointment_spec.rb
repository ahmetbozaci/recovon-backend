...
RSpec.describe Appointment, type: :model do
  describe 'Appointment validation tests' do
    subject do 
      ...
      @doctor1 = Doctor.create!(user_id: @user1.id, name: 'doctor1', location: 'lebanon', specification: 'eye specialist', picture: 'url', price: 25000, description: 'friendly and caring')
